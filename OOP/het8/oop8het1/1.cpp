...
{
    cout << "\nSzülõ rajt idõ: "; kiir_i1(); return *this;
}
...
{
    cout << "\nGyerek rajt idõ: "; kiir_i1(); return *this;
}
...
{
    cout << "\nUnoka rajt idõ: "; kiir_i1(); return *this;
}
...
void mind1(tri_race& x_tri)
{
    ...
    try
    {
       ...
       cout << "\nSzülõ objektum vagyok: " << rp.getLic() << endl;*/
    ...
    catch (bad_cast)
    {
        ...
        catch (bad_cast)
        {
            ...
            cout << "Szülõ objektum vagyok: " << rp.getLic() << endl;
        }
    }
}

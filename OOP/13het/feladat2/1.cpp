...
void in_ch::fuz(in_ch* x_tri)
 { objs.push_back(x_tri); cout << ", a cime: " << x_tri << endl; }
...
in_ch::~in_ch()
 { 
  ...
  cout << "\nFelszabaditottam a gyerek-objektum sajat adatanak a memoriacimét. "; }
